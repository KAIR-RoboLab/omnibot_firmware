...
#define COUNTS_PER_REV1 200477               // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 194543               // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 207199               // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 207199               // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.065                // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.024            // distance between left and right wheels
